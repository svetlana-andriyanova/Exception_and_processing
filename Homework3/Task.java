 ...
 */
 ...
 public class Task {
     public static void main(String[] args) {
         PersData persData = new PersData(); // Создается объект класса ParsData
         String newFileName = null; 
         WriteFile writeFile = new WriteFile(); 
 
         HashMap<String, Object> data = persData.parsInputData(); 
         while (data.size() != 6) {
             try {
                 throw new DataException();
             } catch (DataException e) {
                 data = persData.parsInputData();
             }
         } 
